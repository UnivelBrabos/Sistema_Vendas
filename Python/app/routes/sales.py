...
from schemas.vendas import VendasCreate, VendasUpdate
from fastapi import APIRouter, Depends

router = APIRouter()

@router.post('/sales/post')
async def insert_sales(sale: VendasCreate):
...
async def update_sales(id: int, update: VendasUpdate):
