...
from app.schemas.itens_vendas import ItensVendaCreate
from fastapi import APIRouter, Depends

router = APIRouter()

@router.post('/sales_items/post')
def insert_sales_items(salesItens: ItensVendaCreate):
...
def update_sales_items(id: int, update: ItensVendaCreate):
